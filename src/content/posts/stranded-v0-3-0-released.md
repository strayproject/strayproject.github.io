---
title: Stranded v0.3.0 released!
author: sabro
pubDate: 2026-04-28
urlSlug: stranded-v0.3.0-released
description: Terry time
tags: stranded update
---
Stranded v0.3.0 has been released! You may download it from the [v0.3.0 release page](https://github.com/strayproject/strayproject.github.io/releases/tag/v0.3.0), or head to the [Stranded page](/stranded.html#download) for the latest version.
...
## Upcoming Updates
I've revamped the gallery for the next release that allows for pinching and zooming on gallery images for mobile devices. You can see how it works here:

<div class="not-prose my-6">
  <video class="mx-auto w-full rounded-lg" controls playsinline preload="metadata">
    <source src="/assets/video/posts/gallery_kim_zoom.mp4" type="video/mp4" />
    Your browser does not support the video tag.
  </video>
  <p class="mt-2 text-center text-sm text-gray-700">Yes... zoom in to your heart's content.</p>
</div>

We hope you enjoy update v0.3.0! Thank you again for your support!
