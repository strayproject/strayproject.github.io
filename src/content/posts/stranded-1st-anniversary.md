...
<ol class="items-center sm:flex not-prose" markdown="0">
    <li class="relative mb-6 sm:mb-0">
        <div class="flex items-center">
            <div class="flex z-10 justify-center items-center w-6 h-6 bg-blue-200 rounded-full ring-0 ring-white sm:ring-8 shrink-0">
        ...
        <div class="mt-3 sm:pr-8">
            <h3 class="text-lg font-semibold text-gray-900">Stranded-0</h3>
            <time class="block mb-2 text-sm font-normal leading-none text-gray-700">until Oct 23, 2021</time>
        </div>
    </li>
    <li class="relative mb-6 sm:mb-0">
        <div class="flex items-center">
        ...
        <div class="mt-3 sm:pr-8">
            <h3 class="text-lg font-semibold text-gray-900">Stranded Prologue</h3>
            <time class="block mb-2 text-sm font-normal leading-none text-gray-700">Jun 24, 2021</time>
        </div>
    </li>
    <li class="relative mb-6 sm:mb-0">
        <div class="flex items-center">
        ...
        <div class="mt-3 sm:pr-8">
            <h3 class="text-lg font-semibold text-gray-900">Stranded Chapter 1</h3>
            <time class="block mb-2 text-sm font-normal leading-none text-gray-700">Nov 26, 2021</time>
        </div>
    </li>
    <li class="relative mb-6 sm:mb-0">
        <div class="flex items-center">
        ...
        <div class="mt-3 sm:pr-8">
            <h3 class="text-lg font-semibold text-gray-900">Stranded Chapter 2</h3>
            <time class="block mb-2 text-sm font-normal leading-none text-gray-700">2022??</time>
        </div>
    </li>
</ol>
